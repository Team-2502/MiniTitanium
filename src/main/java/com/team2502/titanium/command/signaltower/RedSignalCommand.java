...
public class RedSignalCommand extends Command
{
    private SignalTowerSubsystem signalTower;

    public RedSignalCommand()
    {
    ...
    @Override
    protected void initialize() {/*signalTowerSubsystem.switchColor_R();*/}

    @Override
    protected void execute() { signalTower.switchColor_R(); }
